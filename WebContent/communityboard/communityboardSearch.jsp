...
//-----------------------------------실제 페이지 네비게이션 출력--------------------------------
			...
			if(nowPage > 1){
				out.print("<a href='community.do?command=community_search&page=1&search1='"+search1 +"'&search2='"+search2 +">◀◀</a>&nbsp;&nbsp;&nbsp;"); // 첫페이지
				out.print("<a href='community.do?command=community_search&page=" + prevPage + "'>&nbsp;이전</a>&nbsp;&nbsp;&nbsp;");  //이전페이지로 이동
			}
			
			
			for(int i=startPage; i <= endPage; i++){ 
				out.print("<a href='community.do?command=community_search&page=" + i + "&search1="+search1 +"&search2="+search2+"'>" + i + "</a>&nbsp;&nbsp;&nbsp;");
			}
