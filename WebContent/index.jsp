			...
			<c:choose>
				<c:when test="${status.first }">
					<div id="myimgs${status.count }" class="myimgscls"
						...
						<div style="width: 55%; margin: auto; height: 55%">
							<a
								href='community.do?command=community_view&communityNum=${imgs.communityNum}'>
								<img src="${imgs.file }" class="img-rounded" alt="Cinque Terre"
				...
				<c:otherwise>
					<div id="myimgs${status.count }" class="myimgscls"
						...
						<div
							style="width: 55%; margin: auto; height: 55%; text-align: center;">
							<a
								href='community.do?command=community_view&communityNum=${imgs.communityNum}'>
								<img src="${imgs.file }" class="img-rounded" alt="Cinque Terre"
								style="height: 25%; width: 25%">
